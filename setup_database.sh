...
echo ""
echo "You'll be prompted for your MySQL root password for each step."
echo ""
...
echo "  mysql -u root -p healthcare_analytics"
echo ""
echo "Try running some analytics queries:"
echo "  mysql -u root -p healthcare_analytics < sql/queries/01_patient_analytics.sql"
echo ""